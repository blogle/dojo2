...
NAMED_RANGE_CONTRACT: tuple[NamedRangeContractEntry, ...] = (
    NamedRangeContractEntry(
        ...
        required=True,
        semantic_role="transaction dates",
        parser="transaction_vectors",
        table="transactions",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.COLUMN_VECTOR,
        required=True,
        semantic_role="transaction outflows",
        parser="transaction_vectors",
        table="transactions",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.COLUMN_VECTOR,
        required=True,
        semantic_role="transaction inflows",
        parser="transaction_vectors",
        table="transactions",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.COLUMN_VECTOR,
        required=True,
        semantic_role="transaction categories",
        parser="transaction_vectors",
        table="transactions",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.COLUMN_VECTOR,
        required=True,
        semantic_role="transaction accounts",
        parser="transaction_vectors",
        table="transactions",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.COLUMN_VECTOR,
        required=True,
        semantic_role="transaction memos",
        parser="transaction_vectors",
        table="transactions",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.COLUMN_VECTOR,
        required=True,
        semantic_role="transaction statuses",
        parser="transaction_vectors",
        table="transactions",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.COLUMN_VECTOR,
        required=True,
        semantic_role="allocation dates",
        parser="allocation_vectors",
        table="allocations",
    ),
    NamedRangeContractEntry(
        "allocations.amount",
        ...
        NamedRangeShape.COLUMN_VECTOR,
        required=True,
        semantic_role="allocation amounts",
        parser="allocation_vectors",
        table="allocations",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.COLUMN_VECTOR,
        required=True,
        semantic_role="allocation source categories",
        parser="allocation_vectors",
        table="allocations",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.COLUMN_VECTOR,
        required=True,
        semantic_role="allocation destination categories",
        parser="allocation_vectors",
        table="allocations",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.COLUMN_VECTOR,
        required=False,
        semantic_role="allocation memos",
        parser="allocation_vectors",
        table="allocations",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.COLUMN_VECTOR,
        required=True,
        semantic_role="net worth dates",
        parser="net_worth_vectors",
        table="net_worth",
    ),
    NamedRangeContractEntry(
        "net_worth.amount",
        ...
        NamedRangeShape.COLUMN_VECTOR,
        required=True,
        semantic_role="net worth amounts",
        parser="net_worth_vectors",
        table="net_worth",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.COLUMN_VECTOR,
        required=True,
        semantic_role="net worth categories",
        parser="net_worth_vectors",
        table="net_worth",
    ),
    NamedRangeContractEntry(
    ...
    NamedRangeContractEntry(
        ...
        NamedRangeShape.COLUMN_VECTOR,
        required=False,
        semantic_role="deposit budget account names",
        parser="config_vectors",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.COLUMN_VECTOR,
        required=False,
        semantic_role="credit card budget account names",
        parser="config_vectors",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.COLUMN_VECTOR,
        required=False,
        semantic_role="credit card account names",
        parser="config_vectors",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.COLUMN_VECTOR,
        required=False,
        semantic_role="account entity names",
        parser="config_vectors",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.COLUMN_VECTOR,
        required=False,
        semantic_role="hidden account names",
        parser="config_vectors",
    ),
    NamedRangeContractEntry(
    ...
    NamedRangeContractEntry(
        ...
        required=True,
        semantic_role="configuration structure block",
        parser="table_block",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.COLUMN_VECTOR,
        required=False,
        semantic_role="category target amounts",
        parser="config_vectors",
        table="category_metadata",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.COLUMN_VECTOR,
        required=False,
        semantic_role="category goal metadata",
        parser="config_vectors",
        table="category_metadata",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.COLUMN_VECTOR,
        required=False,
        semantic_role="category linked accounts",
        parser="config_vectors",
        table="category_metadata",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.COLUMN_VECTOR,
        required=False,
        semantic_role="hidden category names",
        parser="config_vectors",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.COLUMN_VECTOR,
        required=False,
        semantic_role="net worth debt categories",
        parser="config_vectors",
    ),
    NamedRangeContractEntry(
        ...
        required=True,
        semantic_role="available-to-budget label",
        parser="scalar_label",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.SCALAR_OR_LABEL,
        required=True,
        semantic_role="account transfer label",
        parser="scalar_label",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.SCALAR_OR_LABEL,
        required=True,
        semantic_role="balance adjustment label",
        parser="scalar_label",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.SCALAR_OR_LABEL,
        required=True,
        semantic_role="starting balance label",
        parser="scalar_label",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.SCALAR_OR_LABEL,
        required=True,
        semantic_role="approved status symbol",
        parser="scalar_label",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.SCALAR_OR_LABEL,
        required=True,
        semantic_role="pending status symbol",
        parser="scalar_label",
    ),
    NamedRangeContractEntry(
        "labels.break_symbol",
        ...
        NamedRangeShape.SCALAR_OR_LABEL,
        required=True,
        semantic_role="break row symbol",
        parser="scalar_label",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.SCALAR_OR_LABEL,
        required=True,
        semantic_role="category group row symbol",
        parser="scalar_label",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.SCALAR_OR_LABEL,
        required=True,
        semantic_role="reportable category row symbol",
        parser="scalar_label",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.SCALAR_OR_LABEL,
        required=False,
        semantic_role="non-reportable category row symbol",
        parser="scalar_label",
    ),
    NamedRangeContractEntry(
        ...
        NamedRangeShape.SCALAR_OR_LABEL,
        required=True,
        semantic_role="debt or credit-card payment category row symbol",
        parser="scalar_label",
    ),
)
