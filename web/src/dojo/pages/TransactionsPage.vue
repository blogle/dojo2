...
const pageStart = computed(() => (app.state.transactions.length === 0 ? 0 : app.state.transactionOffset + 1));
const pageEnd = computed(() => app.state.transactionOffset + app.state.transactions.length);
    ...
    <Panel>
      ...
      <div class="pagination-bar">
        <span class="page-summary">
          Showing {{ pageStart }}-{{ pageEnd }} of {{ app.state.transactionTotal }}
        </span>
