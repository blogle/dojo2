...
export default defineFixtures<CurrencyFieldProps>({
  ...
  description:
    "Money input with a fixed currency prefix for funding and goal forms.",
  scenarios: [
    {
      name: "default",
      props: {
        ...
        modelValue: "125.00",
        helper:
          "Displays tabular numeric values while keeping the input height aligned with other controls.",
      },
    },
  ],
});
